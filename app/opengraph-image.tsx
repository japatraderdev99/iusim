...
export const alt = 'Iusim — Estratégia Visual'
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <path
              d="M354.35,172.14c45.37-44.77,90.39-55.71,139.29-55.71,56.82,0,111.97,30.1,151.19,76.43l29.69-4.18c-49.4-60.8-105.16-89.18-174.43-89.18-61,0-110.91,29.95-145.74,72.64Z"
              fill="#f5f0ea"
            />
            <path
              d="M841.29,363.55c40.38,51.87,43.71,99.56,39.32,148.36-5.39,59.79-32.67,107.28-68.41,141.91l3.33,25.56c56.46-47.03,83.08-107.18,83.08-173.17,0-57.87-25.21-111.66-57.32-142.67h0Z"
              fill="#f5f0ea"
            />
            <path
              d="M161.58,646.57c-40.38-51.87-46.78-99.56-45.67-143.27,1.61-59.84,32.11-112.67,69.92-147.31l-2.12-25.71c-55.4,42.25-86.31,97.85-86.31,163.84,0,53.49,25.96,114.94,64.18,152.45Z"
              fill="#f5f0ea"
            />
            <path
              d="M325.87,816.97c45.37,51.93,93.21,76.88,162.43,78.14,56.82,1.06,111.46-23.49,158.55-63.52-43.15,38.16-92.31,50.77-143.27,49.3-56.82-1.66-110.4-25.91-149.22-67.8l-28.48,3.88Z"
              fill="#f5f0ea"
            />
          </svg>
        ...
        >
          ...
          >
            Cinematografia de rigor técnico para defesa do VGV e aceleração de
            liquidez no mercado imobiliário premium.
          </span>
        </div>
      </div>
